...
func (r *Reconciler) Reconcile(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	if !instance.Spec.Features.ReconcileMonitoring {
		// reconciling Monitoring is disabled
...
func (r *Reconciler) reconcileConfiguration(ctx context.Context, request ctrl.Request) (ctrl.Result, error) {
	...
	configData.PrometheusK8s.Retention = nil
	...
	changed := !bytes.Equal(b, configDataJSON)
