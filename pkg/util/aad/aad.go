...
func GetToken(ctx context.Context, log *logrus.Entry, clientID string, clientSecret api.SecureString, tenantID string, aadEndpoint, resource string) (*adal.ServicePrincipalToken, error) {
